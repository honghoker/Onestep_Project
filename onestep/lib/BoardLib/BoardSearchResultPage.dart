...
class BoardSearchResultPage extends StatefulWidget {
  @override
  _BoardSearchResultPageState createState() => _BoardSearchResultPageState();
}

class _BoardSearchResultPageState extends State<BoardSearchResultPage> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: _isSearchMode == false
            ? Center(
                child: Text("게시판", style: TextStyle(color: Colors.black)),
              )
            : Column(
                children: [
                  Padding(
