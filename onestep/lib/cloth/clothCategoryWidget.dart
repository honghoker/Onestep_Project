...
class ClothCategoryWidget extends StatefulWidget {
  final String category;
  final CategoryProuductProvider productProvider;
  ClothCategoryWidget({Key key, this.productProvider, this.category})
      : super(key: key);

  @override
  _ClothCategoryWidgetState createState() => _ClothCategoryWidgetState();
}

class _ClothCategoryWidgetState extends State<ClothCategoryWidget> {
  int _headerindex;
  ...
  void initState() {
    ...
    widget.productProvider.fetchProducts(widget.category);
    super.initState();
  }
  ...
  void scrollListener() {
    if (_scrollController.position.pixels ==
      ...
      widget.productProvider.fetchNextProducts(widget.category);
    }
  }
